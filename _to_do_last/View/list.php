...
<body>
    <div class="container">
        ...
        <div class="form-container">
            <form id="addTaskForm">
                <h2>Add New Task</h2>
                <input type="text" id="taskTitle" name="task_title" placeholder="Task Title" required>
                <input type="text" id="taskContent" name="task_content" placeholder="Task Content" required>
        ...
        <!-- <a class="btn" href="index.php/">url</a>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (tasks["data"].length === 0)
                        tableBody.append(`
                        <tr>
                            <td colspan="5">Chưa có task nào!</td>
                        </tr> 
                        `);
                    else
        ...
        $('#addTaskForm').submit(function (event) {
            ...
            let task_title = $('#taskTitle').val();
            let task_content = $('#taskContent').val();
            let task_status = $('#taskStatus').val();
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (tasks["data"].length === 0)
                        tableBody.append(`
                        <tr>
                            <td colspan="5">Không tồn tại tên task có chứa chuỗi ký tự "${$('#searchQuery').val()}"!</td>
                        </tr>
                        `);
                    else
                        tasks["data"].forEach(function (task) {
